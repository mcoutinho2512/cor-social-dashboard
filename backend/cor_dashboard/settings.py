"""
Django settings for COR Social Dashboard project.
"""
...
ROOT_URLCONF = 'cor_dashboard.urls'
...
WSGI_APPLICATION = 'cor_dashboard.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='cor_social_dashboard'),
...
GOOGLE_PLAY_SERVICE_ACCOUNT = config('GOOGLE_PLAY_SERVICE_ACCOUNT', default='')

APPLE_APP_ID = config('APPLE_APP_ID', default='')
APPLE_KEY_ID = config('APPLE_KEY_ID', default='')
APPLE_ISSUER_ID = config('APPLE_ISSUER_ID', default='')
...
GOOGLE_ANALYTICS_CREDENTIALS = config('GOOGLE_ANALYTICS_CREDENTIALS', default='')
